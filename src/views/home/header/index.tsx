		...
		<>
			...
			>
				<Popover
					content={
						<Row style={{ width: "300px", height: "180px" }} justify={"center"}>
							<Col span={12} style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
								<Avatar style={{ marginRight: 30, marginBottom: 30, backgroundColor: "#87d068" }} size={64}>
									管理员
								</Avatar>
							</Col>
							<Col span={12}>
					...
					trigger="click"
				>
					<Avatar style={{ marginRight: 40, backgroundColor: "#87d068" }} icon={<UserOutlined rev={undefined} />} />
				</Popover>
			</Header>
		</>
	);
